...
/**
 * This example demonstrates an alternative way to call a URL using the Apache
 * HttpClient HttpGet and HttpResponse classes.
 * 
 * I copied the guts of this example from the Apache HttpClient
 * ClientConnectionRelease class, and decided to leave all the try/catch/finally
 * handling in the class. You don't have to catch all the exceptions
 * individually like this, I just left the code as-is to demonstrate all the
 * possible exceptions.
 * 
